...
const generateEpisodes = (seasonNumber: number, count: number): Episode[] => {
  const episodeNames = {
    1: [
      'رستاخیز فرشتگان', 'نبرد سرنوشت', 'راز پنهان', 'آخرین مبارزه',
      'شروع طوفان', 'سایه‌های گذشته', 'نقطه شکست', 'مسیر بازگشت',
      'دشمن پنهان', 'اتحاد نهایی', 'نبرد درون', 'آخرین امید',
      'راز باستانی', 'نقطه بازگشت', 'مسیر سرنوشت', 'پایان راه',
      // Additional episodes for pagination demo
      'فراتر از مرزها', 'نبرد نهایی', 'سرنوشت مقدر', 'آخرین ایستگاه'
    ],
    2: [
      'شروع دوباره', 'سایه تاریکی', 'نبرد بزرگ', 'رازهای گذشته',
      'مسیر انتقام', 'آخرین فرصت', 'نقطه شکست', 'اتحاد قهرمانان',
      'نبرد نهایی', 'سرنوشت تاریک', 'راز پنهان', 'آخرین نبرد',
      'مسیر رستگاری', 'نقطه پایان', 'آخرین امید', 'سرنوشت نهایی',
      // Additional episodes for pagination demo
      'راه بی‌پایان', 'آخرین نور', 'مسیر تاریکی', 'سپیده‌دم'
    ],
    3: [
      'فصل جدید', 'راه بی‌پایان', 'نبرد سرنوشت‌ساز', 'رازهای کهن',
      'مسیر رستگاری', 'آخرین نفس', 'نقطه عطف', 'اتحاد ابدی',
      'نبرد پایانی', 'سرنوشت روشن', 'راز نهایی', 'آخرین فصل',
      'مسیر آزادی', 'نقطه آغاز', 'امید تازه', 'پایان داستان',
      // Additional episodes for pagination demo
      'فراسوی افق', 'آخرین پرده', 'مسیر جاودانگی', 'طلوع دوباره'
    ]
  };
  ...
  return Array.from({ length: count }, (_, i) => ({
    ...
    imageUrl: `/episode-images/image-${i + 1}.png`,
...
export const mockSeriesData: Series = {
  ...
  ageRating: 'مناسب برای بالای ۱۸ سال',
