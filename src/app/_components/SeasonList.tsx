...
import { Tabs, TabList, TabTrigger, TabContent } from "@/shared/components/tabs/Tabs";

const SEASON_ONE_EPISODES = Array.from({ length: 16 }, (_, i) => ({
    id: i + 1,
...
const SEASON_TWO_EPISODES = Array.from({ length: 16 }, (_, i) => ({
    id: i + 1,
    title: 'مرد آهنی: انتقام برای آزادی',
    episodeName: [
        'شروع دوباره',
