...
export function EpisodeCard({
  ...
  return (
    <div className={styles.base({ className })} title={`فصل ${season} قسمت ${episode}`}>
...
const episodeCard = tv(
  {
    slots: {
      base: 'group cursor-pointer flex flex-row md:flex-col gap-1 ',
      imageContainer:
      ...
      contentContainer: 'flex flex-col justify-center md:justify-start gap-0.5 flex-grow min-w-0',
